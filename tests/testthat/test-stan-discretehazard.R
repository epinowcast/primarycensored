...
test_that(
  ...
  {
    # The hazard route (27) must agree with the explicit-PMF route (26)
    # for any primary that 26 supports. This implicitly validates the
    # analytic path for non-uniform primaries via the 26 cross-check
