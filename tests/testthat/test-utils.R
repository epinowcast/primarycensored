...
test_that(".resolve_pprimary errors on non-function non-string input", {
  expect_error(
    .resolve_pprimary(stats::dunif, 42L),
    "function or a single character string"
  )
})
