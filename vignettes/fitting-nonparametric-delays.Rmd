...
On this bimodal dataset the RE optimisation is still fragile: with bins where the implied hazard is close to 0 or 1 the logit transform pushes the Hessian near singular, and `fitdistrplus` can return error code 10.
