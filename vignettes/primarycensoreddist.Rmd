...
- For more methodological background on delay distributions see [@Park2024].
- For advice on best practices when estimating or handling delay distributions see [@Charniga2024].
