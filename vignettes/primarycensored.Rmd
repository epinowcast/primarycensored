...
ggplot() +
  ...
  labs(
    ...
    y = "Density",
    caption = paste0(
      "Blue density: Truncated samples without secondary censoring\n",
      "Green bars: Truncated samples with secondary censoring\n",
