...
description: "A guide on how to fit distributions using primarycensoreddist and fitdistrplus."
author: Sam Abbott
output:
...
link-citations: true
vignette: >
  %\VignetteIndexEntry{Fitting distributions using primarycensoreddist and fitdistrplus}
...
# Fitting an improved model using `primarycensoreddist` and `fitdistrplus`
...
**Note** Currently this functionality is limited to a single pwindow, and observation time for all data. If this functionality is of interest then please open an issue on the `primarycensoreddist` GitHub page.
