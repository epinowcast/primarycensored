...
The priors below are intentionally informative and centred near the simulation truth so the recovery demo runs quickly.
Widen them (or use weakly informative defaults) when fitting real data where the truth is unknown.
