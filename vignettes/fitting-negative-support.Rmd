...
Distributions on the non-negative reals (lognormal, gamma, Weibull) cannot represent this and the package's current analytical solutions all assume non-negative support.
...
pwindows <- sample(1:3, n, replace = TRUE)
swindows <- sample(1:3, n, replace = TRUE)
...
pcd_data <- pcd_as_stan_data(
  ...
  priors = list(location = c(0, 5), scale = c(0, 2.5)),
