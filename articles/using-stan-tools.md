...
```
    ...
    ## [15] "gengamma_lcdf"                         
    ## [16] "dist_has_positive_support"             
    ## [17] "dist_lcdf"                             
    ## [18] "primary_lpdf"                          
    ## [19] "primarycensored_ode"                   
    ## [20] "primarycensored_log_normalizer"        
    ## [21] "primarycensored_apply_truncation"      
    ## [22] "primarycensored_truncation_bounds"     
    ## [23] "primarycensored_cdf"                   
    ## [24] "primarycensored_lcdf"                  
    ## [25] "primarycensored_lpmf"                  
    ## [26] "primarycensored_pmf"                   
    ## [27] "primarycensored_sone_lpmf_vectorized"  
    ## [28] "primarycensored_sone_pmf_vectorized"
...
```
    ...
    ##  [4] "primarycensored_gamma_uniform_lcdf"    
    ##  [5] "primarycensored_lognormal_uniform_lcdf"
    ##  [6] "log_weibull_g"                         
    ##  [7] "primarycensored_weibull_uniform_lcdf"  
    ##  [8] "gengamma_lcdf"                         
    ##  [9] "primarycensored_gengamma_uniform_lcdf" 
    ## [10] "primarycensored_analytical_lcdf_raw"   
    ## [11] "primarycensored_apply_truncation"      
    ## [12] "primarycensored_truncation_bounds"     
    ## [13] "primarycensored_analytical_lcdf"       
    ## [14] "primarycensored_analytical_cdf"        
...
```
    ...
    ## Stan functions written to: /tmp/RtmpCPx2Vo/expgrowth_rng.stan
