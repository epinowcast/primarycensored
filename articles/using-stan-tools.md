...
```
    ...
    ## [14] "dist_has_positive_support"             
    ## [15] "dist_lcdf"                             
    ## [16] "primary_lpdf"                          
    ## [17] "primarycensored_ode"                   
    ## [18] "primarycensored_log_normalizer"        
    ## [19] "primarycensored_apply_truncation"      
    ## [20] "primarycensored_truncation_bounds"     
    ## [21] "primarycensored_cdf"                   
    ## [22] "primarycensored_lcdf"                  
    ## [23] "primarycensored_lpmf"                  
    ## [24] "primarycensored_pmf"                   
    ## [25] "primarycensored_sone_lpmf_vectorized"  
    ## [26] "primarycensored_sone_pmf_vectorized"
...
```
    ...
    ##  [8] "primarycensored_analytical_lcdf_raw"   
    ##  [9] "primarycensored_apply_truncation"      
    ## [10] "primarycensored_truncation_bounds"     
...
```
    ...
    ## Stan functions written to: /tmp/RtmpMyOqUb/expgrowth_rng.stan
