...
```
    ...
    ## Parameters : 
    ##             estimate Std. Error
    ## alpha     -3.7871344 0.06319654
    ## log_sigma  0.5854609        NaN
    ## eps_1      1.7127407        NaN
    ## eps_2      0.1268170        NaN
    ## eps_3     -0.4512042        NaN
    ## eps_4     -0.2247793 0.16812417
    ## eps_5      0.2842376 0.18083099
    ## eps_6      0.6126884 0.25635487
    ## eps_7      0.3153521 0.32345090
    ## eps_8      0.5202356 0.40181538
    ## eps_9      0.1141572 0.99999996
    ## Loglikelihood:  -3017.849   AIC:  6057.699   BIC:  6119.308 
    ## Correlation matrix:
    ##                 alpha log_sigma eps_1 eps_2 eps_3        eps_4       eps_5
    ## alpha      1.00000000       NaN   NaN   NaN   NaN -0.038785065  0.06381033
    ## log_sigma         NaN         1   NaN   NaN   NaN          NaN         NaN
    ## eps_1             NaN       NaN     1   NaN   NaN          NaN         NaN
    ## eps_2             NaN       NaN   NaN     1   NaN          NaN         NaN
    ## eps_3             NaN       NaN   NaN   NaN     1          NaN         NaN
    ## eps_4     -0.03878507       NaN   NaN   NaN   NaN  1.000000000 -0.60133796
    ## eps_5      0.06381033       NaN   NaN   NaN   NaN -0.601337960  1.00000000
    ## eps_6      0.08695743       NaN   NaN   NaN   NaN  0.081766051 -0.65054238
    ## eps_7      0.02285850       NaN   NaN   NaN   NaN -0.016419713  0.29388930
    ## eps_8      0.03308415       NaN   NaN   NaN   NaN  0.008365041 -0.09456853
    ## eps_9      0.00000000       NaN   NaN   NaN   NaN  0.000000000  0.00000000
    ##                 eps_6       eps_7        eps_8 eps_9
    ## alpha      0.08695743  0.02285850  0.033084149     0
    ## log_sigma         NaN         NaN          NaN   NaN
    ## eps_1             NaN         NaN          NaN   NaN
    ## eps_2             NaN         NaN          NaN   NaN
    ## eps_3             NaN         NaN          NaN   NaN
    ## eps_4      0.08176605 -0.01641971  0.008365041     0
    ## eps_5     -0.65054238  0.29388930 -0.094568527     0
    ## eps_6      1.00000000 -0.68180959  0.242769730     0
    ## eps_7     -0.68180959  1.00000000 -0.713483683     0
    ## eps_8      0.24276973 -0.71348368  1.000000000     0
    ## eps_9      0.00000000  0.00000000  0.000000000     1
...
```
    ...
    ##  1 np_weig… 0.0233 0.0230 0.00370 0.00360 0.0174 0.0296  1.00     1452.    1075.
    ##  2 np_weig… 0.327  0.327  0.0138  0.0137  0.305  0.350   1.00     2475.    1846.
    ##  3 np_weig… 0.381  0.381  0.0182  0.0179  0.352  0.411   1.00     2303.    1759.
    ##  4 np_weig… 0.213  0.213  0.0201  0.0199  0.180  0.247   1.00     1825.    1544.
    ##  5 np_weig… 0.157  0.157  0.0220  0.0222  0.123  0.194   1.00     1615.    1775.
    ##  6 np_weig… 0.232  0.232  0.0283  0.0273  0.186  0.279   1.00     1701.    1478.
    ##  7 np_weig… 0.475  0.477  0.0373  0.0379  0.412  0.536   1.00     1897.    1846.
    ##  8 np_weig… 0.621  0.622  0.0638  0.0649  0.511  0.726   1.00     1758.    1819.
    ##  9 np_weig… 0.783  0.796  0.100   0.103   0.601  0.927   0.999    1812.    1399.
...
```
    ...
    ##    variable   mean median      sd     mad     q5    q95   rhat ess_bulk ess_tail
    ##    <chr>     <dbl>  <dbl>   <dbl>   <dbl>  <dbl>  <dbl>  <dbl>    <dbl>    <dbl>
    ##  1 np_weig… 0.0242 0.0241 0.00371 0.00385 0.0184 0.0306  1.00     1079.    1033.
    ##  2 np_weig… 0.329  0.329  0.0142  0.0150  0.306  0.353   1.00     2077.    1462.
    ##  3 np_weig… 0.380  0.380  0.0185  0.0190  0.350  0.410   1.00     2259.    1543.
    ##  4 np_weig… 0.214  0.214  0.0195  0.0188  0.182  0.247   1.000    2282.    1639.
    ##  5 np_weig… 0.153  0.153  0.0226  0.0244  0.116  0.190   1.00     2057.    1502.
    ##  6 np_weig… 0.229  0.229  0.0311  0.0302  0.179  0.279   1.00     2423.    1661.
    ##  7 np_weig… 0.478  0.478  0.0385  0.0377  0.415  0.542   1.00     2358.    1884.
    ##  8 np_weig… 0.608  0.610  0.0661  0.0645  0.496  0.716   1.00     2506.    1366.
    ##  9 np_weig… 0.787  0.803  0.110   0.115   0.592  0.940   1.00     1523.    1179.
    ## 10 np_weig… 1      1      0       0       1      1      NA          NA       NA
...
```
    ...
    ##  1 np_pmf[1]  0.0224 0.0224  0.00370 0.00366 0.0165  0.0288 1.00     1352.
    ##  2 np_pmf[2]  0.321  0.321   0.0136  0.0141  0.298   0.343  1.00     3018.
    ##  3 np_pmf[3]  0.249  0.249   0.0142  0.0141  0.226   0.273  1.00     3152.
    ##  4 np_pmf[4]  0.0864 0.0861  0.00870 0.00848 0.0722  0.101  1.00     2143.
    ##  5 np_pmf[5]  0.0500 0.0494  0.00761 0.00757 0.0384  0.0634 1.000    1866.
    ##  6 np_pmf[6]  0.0624 0.0622  0.00834 0.00846 0.0493  0.0761 1.00     1756.
    ##  7 np_pmf[7]  0.0992 0.0991  0.0103  0.0101  0.0821  0.117  1.00     2001.
    ##  8 np_pmf[8]  0.0660 0.0658  0.00916 0.00933 0.0510  0.0813 1.00     2120.
    ##  9 np_pmf[9]  0.0339 0.0334  0.00717 0.00720 0.0229  0.0465 1.00     2172.
    ## 10 np_pmf[10] 0.0101 0.00909 0.00553 0.00495 0.00293 0.0207 1.00     1777.
