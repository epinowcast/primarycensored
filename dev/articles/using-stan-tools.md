...
```
    ...
    ## Stan functions written to: /tmp/Rtmpr9cbQf/expgrowth_rng.stan
...
```
    ...
    ## functions {
    ## // Stan functions from primarycensored version 1.4.0.1000
