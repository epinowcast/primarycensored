...
- [Analytic solutions for censored delay
  distributions](https://primarycensored.epinowcast.org/dev/articles/analytic-solutions.md):

- [Fitting distributions using primarycensored and
  fitdistrplus](https://primarycensored.epinowcast.org/dev/articles/fitting-dists-with-fitdistrplus.md):

  A guide on how to fit distributions using primarycensored and
  fitdistrplus.

- [Fitting distributions using primarycensored and
  cmdstan](https://primarycensored.epinowcast.org/dev/articles/fitting-dists-with-stan.md):
