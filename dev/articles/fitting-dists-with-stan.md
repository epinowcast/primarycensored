...
```
    ...
    ##        variable     mean   median   sd  mad       q5      q95 rhat ess_bulk
    ##  lp__           -3422.70 -3422.42 0.94 0.71 -3424.62 -3421.79 1.00     1300
    ##  params[1]          1.55     1.54 0.04 0.04     1.48     1.62 1.00     1403
    ##  params[2]          0.78     0.78 0.03 0.03     0.73     0.83 1.00     1420
    ##  np_pmf[1]          1.00     1.00 0.00 0.00     1.00     1.00   NA       NA
    ##  lpmf_params[1]     1.55     1.54 0.04 0.04     1.48     1.62 1.00     1403
    ##  lpmf_params[2]     0.78     0.78 0.03 0.03     0.73     0.83 1.00     1420
    ##  ess_tail
    ##      2160
    ##      1450
    ##      1556
