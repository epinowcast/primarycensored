...
hazard-parameterised piecewise-constant delay distribution. Converts
hazards to a PMF via
[`hazards_to_pmf()`](https://primarycensored.epinowcast.org/dev/reference/hazards_to_pmf.md)
then dispatches back through
[`pcens_cdf()`](https://primarycensored.epinowcast.org/dev/reference/pcens_cdf.md)
using a freshly constructed step-distribution object. The same primary
event distribution and arguments are preserved.
